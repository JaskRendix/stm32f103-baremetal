...
static void test_gpio_setup_pin0_crl(void)
{
    ...
    printf("[PASS] test_gpio_setup_pin0_crl\n");
}
...
static void test_gpio_setup_pin7_crl(void)
{
    ...
    printf("[PASS] test_gpio_setup_pin7_crl\n");
}
...
static void test_gpio_setup_pin8_crh(void)
{
    ...
    printf("[PASS] test_gpio_setup_pin8_crh\n");
}
...
static void test_gpio_setup_pin15_crh(void)
{
    ...
    printf("[PASS] test_gpio_setup_pin15_crh\n");
}
...
static void test_gpio_set_clear_pin(void)
{
    ...
    printf("[PASS] test_gpio_set_clear_pin\n");
}
...
static void test_gpio_write_pin(void)
{
    ...
    printf("[PASS] test_gpio_write_pin\n");
}
...
static void test_gpio_set_pull(void)
{
    ...
    printf("[PASS] test_gpio_set_pull\n");
}
...
int main(void)
{
    ...
    printf("All 9 test_gpio cases passed.\n");
    return 0;
}